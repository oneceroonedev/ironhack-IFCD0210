...
console.log("Te llamas " + name + ", vives en " + city + ", y te gusta " + hobby);


//Ejercicio 3
let radius = prompt("Vamos a calcular el area de un círculo. ¿Puedes indicarme cuanto mide el radio? (En cm)");
